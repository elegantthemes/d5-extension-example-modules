 ...
 * @since ??
 */
export const defaultAttrs: ChildModuleAttrs = {};
 ...
 * @since ??
 */
export const defaultPrintedStyleAttrs: ChildModuleAttrs = {};
 ...
 * @since ??
 */
export const defaultSettingsAttrs: ChildModuleAttrs = mergeAttrs({
    defaultAttrs,
