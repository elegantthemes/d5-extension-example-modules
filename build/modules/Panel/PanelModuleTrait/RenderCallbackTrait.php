<?php
/**
 * PanelModule::render_callback()
 *
 * @package CAWeb\Modules\PanelModule
 * @since ??
 */

namespace CAWeb\Modules\Panel\PanelModuleTrait;
...
trait RenderCallbackTrait {
	...
	/**
	 * Panel module render callback which outputs server side rendered HTML on the Front-End.
	 *
	 * @since ??
	 *
			...
			foreach ( $posts as $post ) {
				...
				$post_title_container = HTMLUtility::render(
					[
						...
						'attributes'        => [
							'class' => 'example_Panel_module__post-item-title',
						],
				...
				$post_content = HTMLUtility::render(
					[
						'tag'               => 'div',
						'attributes'        => [
							'class' => 'example_Panel_module__post-item-content',
						],
						'childrenSanitizer' => 'et_core_esc_previously',
				...
				$post_items .= HTMLUtility::render(
					[
						'tag'               => 'div',
						'attributes'        => [
							'class' => 'example_Panel_module__post-item',
						],
						'childrenSanitizer' => 'et_core_esc_previously',
		...
		if ( ! empty( $post_items ) ) {
			$posts_container = HTMLUtility::render(
				[
					'tag'               => 'div',
					'attributes'        => [
						'class' => 'example_Panel_module__post-items',
					],
					'childrenSanitizer' => 'et_core_esc_previously',
					'children'          => $post_items,
				]
				...
				'children'            => [
					...
					HTMLUtility::render(
						[
							'tag'               => 'div',
							'attributes'        => [
								'class' => 'example_Panel_module__inner',
							],
							'childrenSanitizer' => 'et_core_esc_previously',
							'children'          => [
								$title,
